...
public final class ModConfigEvent {
	 ...
	 * <p>
	 * IMPORTANT: Unlike on Forge there are is no mod event bus for firing mod specific events on Fabric, meaning this event is fired for every mod for every config
